        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <div className="flex items-center space-x-10 w-full justify-between">
              ...
              <ul className="hidden md:flex items-center space-x-6 text-black font-medium">
                ...
                <li><Link to="/" className="px-4 py-2 hover:text-sky-600">Products</Link></li>
                <li><Link to="/About" className="px-4 py-2 hover:text-sky-600">About</Link></li>
                <li><Link to="/Gallery" className="px-4 py-2 hover:text-sky-600">Gallery</Link></li>
                <li><Link to="/Contact" className="px-4 py-2 hover:text-sky-600">Contact</Link></li>
              </ul>
            </div>
          ...
          {isOpen && (
            <ul className="md:hidden flex flex-col space-y-4 bg-white shadow-md p-4">
              <li><Link to="/" className="px-4 py-2 hover:text-sky-600">Home</Link></li>
              <li><Link to="/product" className="px-4 py-2 hover:text-sky-600">Products</Link></li>
              <li><Link to="/About" className="px-4 py-2 hover:text-sky-600">About</Link></li>
              <li><Link to="/Gallery" className="px-4 py-2 hover:text-sky-600">Gallery</Link></li>
              <li><Link to="/Contact" className="px-4 py-2 hover:text-sky-600">Contact</Link></li>
            </ul>
